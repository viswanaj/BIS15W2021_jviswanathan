...
## # … with 559 more rows, and 16 more variables: mean.mass.g <dbl>,
...
```
##        0%       25%       50%       75%      100% 
## -1.522879  3.653213  4.594873  6.016239  9.550330
```
...
```
## `summarise()` has grouped output by 'range_category'. You can override using the `.groups` argument.
```

```
## # A tibble: 22 x 3
## # Groups:   range_category [3]
##    range_category taxon             n
##    <chr>          <chr>         <int>
##  1 large          turtles           1
##  2 medium         turtles          13
##  3 large          tortoises         2
##  4 medium         tortoises        10
##  5 large          snakes            3
##  6 medium         snakes           32
##  7 small          snakes            6
##  8 medium         river fishes      1
##  9 small          river fishes     13
## 10 large          marine fishes     5
## # … with 12 more rows
```
