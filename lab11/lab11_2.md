...
##  $ x              : NULL
##  $ y              : chr "n"
##  $ fill           : chr "Trophic Guild"
##  $ title          : chr "Observations by Taxon in Homerange Data"
...
```
## Warning in display.brewer.pal(22, "PRGn"): n too large, allowed maximum for palette PRGn is 11
