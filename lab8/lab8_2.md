...
names(expenditures_tidy)
```

```
## [1] "expenditure"  "year"         "amount_spent"
```
...
```
## # A tibble: 5 x 3
## # Groups:   expenditure [1]
##   expenditure        year  amount_spent
##   <chr>              <chr>        <dbl>
...
```r
sydney_enterococci <- read_csv(here("lab8", "data", "sydneybeaches.csv"))
```
...
```r
sydney_enterococci<- sydney_enterococci %>%
  clean_names()
...
```r
sydney_wide <- sydney_enterococci %>%
  pivot_wider(
    names_from = "site",
    values_from = "beach_id"
  )
...
```
## # A tibble: 3,690 x 17
##    region council longitude latitude date  enterococci_cfu… `Clovelly Beach`
##    <chr>  <chr>       <dbl>    <dbl> <chr>            <dbl>            <dbl>
##  1 Sydne… Randwi…      151.    -33.9 02/0…               19               25
##  2 Sydne… Randwi…      151.    -33.9 06/0…                3               25
##  3 Sydne… Randwi…      151.    -33.9 12/0…                2               25
##  4 Sydne… Randwi…      151.    -33.9 18/0…               13               25
##  5 Sydne… Randwi…      151.    -33.9 30/0…                8               25
##  6 Sydne… Randwi…      151.    -33.9 05/0…                7               25
##  7 Sydne… Randwi…      151.    -33.9 11/0…               11               25
##  8 Sydne… Randwi…      151.    -33.9 23/0…               97               25
##  9 Sydne… Randwi…      151.    -33.9 07/0…                3               25
## 10 Sydne… Randwi…      151.    -33.9 25/0…                0               25
## # … with 3,680 more rows, and 10 more variables: `Coogee Beach` <dbl>, `Gordons
## #   Bay (East)` <dbl>, `Little Bay Beach` <dbl>, `Malabar Beach` <dbl>,
